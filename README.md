...
| **Feature** | **Description** |
|-------------|-----------------|
| **fswatch** | Monitor file system events in real-time. |
| **webcrawl** | Crawl and analyze web applications and extract url list. |
| **gallery-dl** | Download images and videos from various platforms -> [list here](./docs/gallery-dl.md) |
